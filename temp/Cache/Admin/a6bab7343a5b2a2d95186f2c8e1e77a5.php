...
<tr class="tr"><td colspan="2" >百度SiteMap： 总输出<input id="baidu" name="baiduall" type="text" size="5" maxlength="5" value="2500" style="text-align:center">条 每页输出<input id="baidu" name="baidu" type="text" size="5" maxlength="5" value="500" style="text-align:center">条 <input type="submit" value="开始生成" class="bginput" onClick="gxform.action='?s=Admin/Html/Mapbaidu';" <?php if(($url_html)  !=  "1"): ?>disabled<?php endif; ?>/></td></tr>
<tr class="tr"><td colspan="2" >谷歌SiteMap： 总输出<input id="google" name="googleall" type="text" size="5" value="2500" maxlength="5" style="text-align:center">条 每页输出<input id="google" name="google" type="text" size="5" maxlength="5" value="500" style="text-align:center">条 <input type="submit" value="开始生成" class="bginput" onClick="gxform.action='?s=Admin/Html/Mapgoogle';" <?php if(($url_html)  !=  "1"): ?>disabled<?php endif; ?>/></td></tr>
<tr class="tr"><td colspan="2" >RSS订阅文件：总输出<input id="rss" name="rss" type="text" size="5" maxlength="5" value="300" style="text-align:center">条 <input name="开始生成" type="submit" class="bginput" onClick="gxform.action='?s=Admin/Html/Maprss';" value="开始生成" <?php if(($url_html)  !=  "1"): ?>disabled<?php endif; ?>/></td></tr>
...
<tr class="tr"><td colspan="2" >全部影片列表：<input id="top" name="top" type="submit" class="bginput" onClick="gxform.action='?s=Admin/Html/Allvideo';" value="开始生成全部影片列表页" <?php if(($url_html)  !=  "1"): ?>disabled<?php endif; ?>/></td></tr>
<tr class="tr"><td colspan="2" >最新影片列表：<input id="top" name="top" type="submit" class="bginput" onClick="gxform.action='?s=Admin/Html/Newvideo';" value="开始生成最新100个影片列表页" <?php if(($url_html)  !=  "1"): ?>disabled<?php endif; ?>/></td></tr>
<tr class="tr"><td colspan="2" >新片上映列表：<input id="top" name="top" type="submit" class="bginput" onClick="gxform.action='?s=Admin/Html/Releasevideo';" value="开始生成新片上映列表页" <?php if(($url_html)  !=  "1"): ?>disabled<?php endif; ?>/></td></tr>
</form>
</table>
<style>
